...
- [Your $20 AI plan is lying to you](#your-20-ai-plan-is-lying-to-you) (May 7, 2026)
- [An ASML intern's thoughts after two months in](#an-asml-interns-thoughts-after-two-months-in) (Mar 31, 2026)
- [End of summer and starting my Master's degree in AI!](#end-of-summer-and-starting-my-masters-degree-in-ai) (Sep 2, 2025)
- [SaaS por 0€/Mes usando Git como Base de Datos](#saas-por-0mes-usando-git-como-base-de-datos) (June 23, 2025)
- [Un nuevo inicio (ES)](#un-nuevo-inicio-es) (June 18, 2025)
- [A simple automation I use daily (Linkedin, ES)](#a-simple-automation-i-use-daily-linkedin-es) (April 26, 2025)
- [AImbidextro, exploring AI agents in 2d platform game (Linkedin, ES)](#aimbidextro-exploring-ai-agents-in-2d-platform-game-linkedin-es) (April 24, 2025)
- [How to vibe-code, from a vibe coder (Linkedin, ES)](#how-to-vibe-code-from-a-vibe-coder-linkedin-es) (April 19, 2025)
- [My experience in the Innovaxa Hackathon (Linkedin, ES)](#my-experience-in-the-innovaxa-hackathon-linkedin-es) (April 1, 2025)
- [Junior's reality in the IT field in 2025 (Linkedin, ES)](#juniors-reality-in-the-it-field-in-2025-linkedin-es) (March 23, 2025)
- [CV ATS systems are outdated (Linkedin)](#cv-ats-systems-are-outdated-linkedin) (March 18, 2025)
- [MNIST and Cosine similarity (Linkedin)](#mnist-and-cosine-similarity-linkedin) (March 5, 2025)
- [My first live Hackathon (hack2progress.com)](#my-first-live-hackathon-hack2progresscom) (March 3, 2025)
- [My short and long term goals](#my-short-and-long-term-goals) (February 26, 2025)
- [AI agents are not quite there yet (but they are close)](#ai-agents-are-not-quite-there-yet-but-they-are-close) (February 24, 2025)
- [A note to my future employer](#a-note-to-my-future-employer) (February 21, 2025)
- [Humble introduction to GPT models and PyTorch](#humble-introduction-to-gpt-models-and-pytorch) (February 6, 2025)
...
<div align="center">
  <img src="blog/My Coding Stack In 2026/permanent-underclass.jpeg" alt="Permanent Underclass" width="400">
</div>
...
AI tools right now are much more than "smart autocomplete". Many notable people have shown how AI can be used to build very complex systems, e.g: [Senior Staff Software Engineer @ Google explaining how they use Gemini CLI to ship code](https://www.youtube.com/watch?v=SUG-cEMFKFM&t=60s)
...
On the individual level, agentic AI is also **super powerful**: for example, a nice use case that I personally use **Pi.dev** for is preparing for my courses. [Here](https://dkealvaro.github.io/notes/Year_1/Q2/Bayesian%20ML/README.html) are the full notes for a course I took in which I got an 8/10 by ONLY studying from the AI generated notes. (Use the navigation arrows on the side)
...
<div align="center">
  <img src="blog/My Coding Stack In 2026/permanent-underclass-twitter.png" alt="Permanent Underclass" width="400">
</div>
...
Clement Delangue, Co-founder & CEO at Hugging Face - one of the most important companies in the AI/Machine learning world - [highlighted a few days ago](https://x.com/ClementDelangue/status/2053825719587815711) how fast open weight AI has been improving over the past two years:

<div align="center">
  <a href="https://x.com/ClementDelangue/status/2053825719587815711">
    <img src="blog/My Coding Stack In 2026/clem-delangue.png" alt="Open Source Intelligence" width="400">
  </a>
</div>
...
<div align="center">
  <img src="blog/My Coding Stack In 2026/Artificial Analysis Intelligence Index (7 May '26).png" alt="Open Source Intelligence" width="700">
</div>
...
<div align="center">
  <img src="blog/My Coding Stack In 2026/deepseek-usage.png" alt="Open Source Intelligence" width="400">
</div>
...
<img src="blog/My Coding Stack In 2026/setup.jpeg" alt="My coding setup" style="max-width: 350px; display: block; margin: 1.5rem auto; border-radius: 12px;">
...
4. **The number of runs per experiment:** 50% reduction keeping every second run.
...
- Go as much as I can to Madrid. I cannot commit to this though cause it depends more on my economic situation.
...
**Date:** June 23, 2025  
**Overview:** SaaS por 0€/Mes usando Git como Base de Datos  
...
**Date:** June 18, 2025  
**Overview:** Hablo sobre los últimos meses de mi vida y el futuro próximo.  
...
Si no conoces ese mundo, de lo que trata es de hacer dinero con cualquier forma de servicio online. Esto se llama **SaaS (**Software as a Service**)** o **MicroSaaS,** y las formas más comunes son aplicaciones móviles o páginas web, a menudo con suscripciones mensuales. Lo que me llamaba particularmente la atención era la aparentemente sencillez de los productos en comparación a la cantidad de dinero que se podía obtener con ellos. Estamos hablando de varios millones de **[ARR](https://blog.hubspot.es/sales/que-es-arr)** en los casos más extremos como **[CalAI](https://www.cbsnews.com/newyork/news/zach-yadegari-cal-ai-founder-long-island/) o [PhotoAI](http://PhotoAI.com)** y una inversión de capital cercana a 0.

Por lo que he dicho parecía un mercado jugosísimo, así que decidí darme un mes para intentar hacerme un hueco en este mundillo. Descargué **[Cursor](https://www.cursor.com/),** el software más disruptivo de la década en el mundo tech sin ninguna duda. Había escuchado maravillas, prometía desarrollar software sin necesidad de escribir una línea de código, el ansiado '**[vibe coding](https://x.com/karpathy/status/1886192184808149383?lang=en)**'.
...
<figure class="image"><img style="width:288px" src="blog/Un nuevo inicio/image.png" alt="dailyclips-idea" /></figure>
...
<figure class="image"><img style="width:432px" src="blog/Un nuevo inicio/image 1.png" alt="cursor-issues" /></figure>
...
Una de las mejores maneras para promocionar tu producto son las redes sociales, aunque en mi caso no me sirvieron. Me creé una cuenta de Twitter en la que a lo largo de un mes llegué a postear 149 veces acerca de mi producto y consiguió 4 seguidores y menos de 10 likes. Seguramente si hubiera seguido posteando hubiera llegado a hacerme un hueco como '*influencer*', porque al final lo que premian este tipo de plataformas es la constancia. Pero realmente es lo que quería? Obligarme a publicar varias veces al día aunque no aportara nada de valor? Volverme esclavo de las métricas intentando optimizarlas al máximo? A mi no me salía natural ni me parecía una meta clara, además que así te quitaba gran parte de la libertad que ofrecía esta manera de ganarse la vida.

Principalmente por estas razones decidí dejar este campo y buscar un trabajo 'de verdad'

## 2/2 Febrero - Marzo-Abril-1/2 Mayo

El día 21 de febrero publiqué en mi post una entrada titulada '**A note to my future employer**', la puedes leer [aquí](https://dkealvaro.github.io/blog/message-to-employer/index.html). Ahí hablaba un poco del trabajo que había hecho hasta entonces y mis expectativas para el primer trabajo que encontrara. 
...
<figure class="image"><img style="width:384px" src="blog/Un nuevo inicio/image 2.png" alt="friends-hackathon" /></figure>
...
<figure class="image"><img style="width:336px" src="blog/Un nuevo inicio/a8faad95-8121-453e-9063-fb4c056984db.png" alt="business-cards" /></figure>
...
Poco a poco conseguía entrevistas, pero nunca lograba pasar de la primera o segunda fase. A lo largo de estos meses, solicité (conscientemente) alrededor de 300 empleos y conseguí entrevistas en 23 empresas. De hecho, las iba apuntando y guardando los motivos en mi página web. Este contenido está oculto, pero si has llegado hasta aquí mereces saber que se encuentra en [https://dkealvaro.github.io/failures](https://dkealvaro.github.io/failures). Puedes echarle un ojo para ver mis intentos.
...
**Date:** April 26, 2025  
**Overview:** This is how I prevent my Linkedin posts from falling into oblivion using Python  

This post is external. You can find the original publication on LinkedIn at the following link:  
[A simple automation I use daily (Linkedin, ES)](https://www.linkedin.com/feed/update/urn:li:share:7321475825097142272)
...
**Date:** April 24, 2025  
**Overview:** I created a simple but powerful API to interact with Ambidextro game to develop reinforcement learning agents inside the game  

This post is external. You can find the original publication on LinkedIn at the following link:  
[AImbidextro, exploring AI agents in 2d platform game (Linkedin, ES)](https://www.linkedin.com/feed/update/urn:li:ugcPost:7321149163025362944)
...
**Date:** April 19, 2025  
**Overview:** (ES) The experience of a vibe coder with a concrete example, this website!  

This post is external. You can find the original publication on LinkedIn at the following link:  
[How to vibe-code, from a vibe coder (Linkedin, ES)](https://www.linkedin.com/feed/update/urn:li:share:7318950372046180353)
...
**Date:** April 1, 2025  
**Overview:** (ES) I explain how the hackathon went from the perspective of a participant, including what we did good and wrong.  

This post is external. You can find the original publication on LinkedIn at the following link:  
[My experience in the Innovaxa Hackathon (Linkedin, ES)](https://www.linkedin.com/feed/update/urn:li:share:7312060356808392704)
...
**Date:** March 23, 2025  
**Overview:** (ES) In this post, I talk about the reality of applying to junior developer positions in IT in Spain. Specifically AI/Data Science related fields  

This post is external. You can find the original publication on LinkedIn at the following link:  
[Junior's reality in the IT field in 2025 (Linkedin, ES)](https://www.linkedin.com/feed/update/urn:li:share:7308886058807496704)
...
**Date:** March 18, 2025  
**Overview:** My thoughts on ATS systems after applying to hundreds of positions...  

This post is external. You can find the original publication on LinkedIn at the following link:  
[CV ATS systems are outdated (Linkedin)](https://www.linkedin.com/feed/update/urn:li:share:7307762914461978627)
...
**Date:** March 5, 2025  
**Overview:** Achieved 75% accuracy in the MNIST dataset using a simple cosine similarity approach under 50 lines of code, with no training  

This post is external. You can find the original publication on LinkedIn at the following link:  
[MNIST and Cosine similarity (Linkedin)](https://www.linkedin.com/feed/update/urn:li:share:7302993023510978560)
...
**Date:** March 3, 2025  
**Overview:** I will dive into the details of my first live Hackathon  
...
<figure style="text-align:center">
    <img src="blog/hack2progress/santannext.png" alt="Santan'next UI" style="max-width: 80%;" />
</figure>
...
<figure style="text-align:center">
    <img style="width:504px" src="blog/hack2progress/santannext-UI.png" alt="Santan'next UI" />
</figure>

More info about the project in our GitHub repo: [here](https://github.com/DKeAlvaro/Hack2Progress)
...
(Presentation PDF is available in the repository / original post: Hack2Progress.pdf)
...
### What we did well:
- **We spent around 3-5% of our time coding:** It was a one day hackathon, so we decided it was better to have a **polished product** with a **neat presentation** to convince the judges. It turned out to be the best thing we could have done, as at no point they asked us to show our code or what we achieved in those terms.
- **Everyone worked efficiently:** It was not the case that some people in the team were not contributing or lost, not knowing what to work on. I mainly worked on the presentation and (small) backend. Another two teammates mainly focused on the users application, and another one worked on the branding and looks of the application.

### What we could have improved:
- **The message was not clear during the presentation:** The presentation was 5 minutes long, and I feel we did not convey the message clearly. We went through the slides very fast which led to moments where what we were showing could not be explained and that probably confused the audience. Especially with the diagrams. For the next time, we will condense all the information instead of trying to cover all the aspects. In case the audience has any questions, they can ask. But what we add to the presentation, needs to be clear.
- **Picking a more generalist topic:** I think our idea caught off guard many people, as it was very different to most of other teams ideas. Many of them were like "having public transport cards in your phone device", "Improving last mile delivery" (Winner team), "Adding walkable tiles that create energy off people walking in the streets". However, creating web browsing agents to identify important events was not something they expected IMHO.
...
**Overview:** A personal post where I open up about me. Please don't judge!  

Today is the 26th of February  2025 and I am 21 years old. When I think about what I want to achieve in the long run, I feel my way of thinking has not changed a lot since I was a child. I have always had the same goal:

Finding a wife whom I can share my life with and create a family. This goes above everything else. In that sense, I have to admit I am very traditional, and I don't doubt it's because of the way I have been raised. Apart from that, I would like to have a stable job where I am comfortable and I enjoy it. 

My parents always gave me the impression that working implies doing something you really hate 8 hours a day 5 days a week and being tied to it 11 months per year. Ideally, I would like to avoid that, and find a job where I have more flexibility to work and take breaks whenever I decide, and especially, a job that I enjoy. Buut, I know that's difficult🤷‍♂️.

In terms of career choices, well, I still don't know what I want to do. I don't even know what I want to do now. What I am currently doing is, just picking something and sticking to it. In my case, now it's data science. I have been working on many projects for the last couple of months and they have been nice, but I am lacking that real world working experience. 

Which leads me to the following point, my short term goals.

As I said, I'm lacking real life working experience, and what I mean by that, is working with a team that delivers large scale solutions. A team with senior people I can learn from. And that's what I would like to achieve in the next couple of years: learning from people who know more than me. In addition to that, I would like to study a Master's degree. More specifically, I just applied to a 2 year Master's degree in Copenhagen. I would love to get accepted and complete my education there.
...
**Overview:** I used the new best AI web agent to apply for a LinkedIn job and it didn't perform as expected... Spoiler, it couldn't complete the task  

I used the new best AI web agent to apply for a LinkedIn job and here is the result. Spoiler, it couldn't complete the task.

<div class="video-container" style="display: flex; justify-content: center; margin: 20px 0;">
    <p><em>(Video demo.mp4 is available in the original blog post folder)</em></p>
</div>
...
The fact that the model achieved an 89% on WebVoyager but still struggled with a simple task highlights the necessity of decentralized benchmarks where everyone can upload and test their own tasks (See [Agent2Bench](https://dkealvaro.github.io/Agent2Bench/)). It is especially funny because in the Browser Use repo they show an example using the agent in Linkedin.
...
**Overview:** What I would like my future employer to know about me  
...
Since then, I have been working as a **Software Developer** for the Dutch company **[Sqippa](https://www.sqippa.com/en/)**, in which I developed from the ground up a full stack web application which allowed users to create their own schedules for IOT devices, including Authentication, API endpoints/requests and web deployment.

<div class="image-grid" style="display: flex; justify-content: space-between;">
    <figure style="flex: 1; margin-right: 10px;">
        <img src="blog/message-to-employer/image.png" alt="Sqippa Screenshot 1" style="max-width: 100%; height: auto;">
    </figure>
    <figure style="flex: 1; margin-left: 10px;">
        <img src="blog/message-to-employer/image 1.png" alt="Sqippa Screenshot 2" style="max-width: 100%; height: auto;">
    </figure>
</div>
...
## DailyClips
<div class="project-section" style="display: flex; align-items: center;">
    <div class="project-description" style="flex: 1; margin-right: 10px;">
        <p><a href="https://www.dailyclips.es">DailyClips</a> was born with the idea that learning english is better via the <a href="https://www.mimicmethod.com/the-method/">mimic method</a> (it basically states that a good way to learn is by hearing and repeating).</p>
        <p>The app shows users 5 different movie clips every day and allows them to repeat what they heard, and get scored by a speech to text model.</p>
        <p>Although the app hasn't gotten many traction, I will continue improving it as I believe is a really helpful tool.</p>
    </div>
    <figure style="flex: 1;">
        <img src="blog/message-to-employer/image 2.png" alt="DailyClips Screenshot" style="max-width: 100%; height: auto;">
    </figure>
</div>
...
<figure style="display: flex; justify-content: center;">
    <img src="blog/message-to-employer/image 3.png" alt="GPT-Primavera Results" style="max-width: 80%; height: auto;">
</figure>

See more [here](https://github.com/DKeAlvaro/GPT-Primavera)
...
<figure>
    <img src="blog/message-to-employer/image 4.png" alt="Hackathon Results" style="max-width: 100%; height: auto;">
</figure>

## DumbGPT
Large Language Models like chatGPT have been all over the place since 2022, but few people really know how they work. Thats why I decided to learn about them following **Andrej Karpathy's** [minGPT repository](https://github.com/karpathy/minGPT), which is the simplest implementation of GPT models.

However, I still found his repository to be too complex, therefore I created [dumbGPT](https://github.com/DKeAlvaro/dumbGPT), which explains a full walkthrough of a GPT model from data processing until model inference.

To show it works, I applied it to a casino game and you can see the results here (In spanish):  
*(Video available at https://www.youtube.com/embed/RLNqwgZhxzA)*

## Agent2Bench
Agent2Bench is a proposed benchmark that tests LLMs abilities in daily life computer tasks like booking flights, downloading programs or exiting vim. A demo can be found [here](https://dkealvaro.github.io/Agent2Bench/)

## Jupyter Style CV Generator
A simple web application that generates CVs in the style of Jupyter Notebooks (See example below). Code [here](https://github.com/DKeAlvaro/Jupyter-Style-CV-Generator)

<figure>
    <img src="blog/message-to-employer/image 5.png" alt="CV Generator Example" style="max-width: 100%; height: auto;">
</figure>
...
3. ### Marketing and sales
   ...
   <figure>
       <img src="blog/message-to-employer/image 1.png" alt="LinkedIn Post" style="max-width:300px; height: auto;">
   </figure>
...
4. ### Knowing what I want and what I don't want
   ...
   - **I can learn from my team.**
   - **It will have a positive impact in my career.**
   - **The work I perform is impactful**
   - **I enjoy it**

So, if you have read all until now and would like to collaborate with me, don't hesitate to send me a message to <a href="mailto:alvaro.mrgr@gmail.com">alvaro.mrgr@gmail.com</a>
...
**Overview:** The beginner-friendly introduction to GPT models and PyTorch I would have liked to have.  

In this article I will go through the simplest GPT implementation made by **Andrej Karpathy,** you can find all the code [here](https://colab.research.google.com/drive/1JMLa53HDuA-i7ZBmqV7ZnA3c_fvtXnx-?usp=sharing). Only prerequisite is to code more or less good in *python.*
...
So, when they say a model has 100M parameters, they mean that the sum of all smaller components of the bigger model, sum up to that amount. Now, if you had forgotten the super().\_\_init\_\_(), it wouldn't track the parameters for that component.

Another important part about this modularization is that now you should more or less understand these scary diagrams:

<figure>
    <img src="blog/gpt-intro/image.png" alt="Original transformer architecture" style="max-width: 40%; height: auto;">
...
<figure>
    <img src="blog/gpt-intro/image 2.png" alt="GPT architecture" style="max-width: 70%; height: auto;">
...
<figure>
    <img src="blog/gpt-intro/image 2.png" alt="GPT implementation diagram" style="max-width: 70%; height: auto;">
</figure>
